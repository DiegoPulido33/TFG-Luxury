      ...
      <main className="flex-1">
        ...
        <section className="relative">
          <div 
            ...
            style={{
              backgroundImage: "url('https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?ixlib=rb-1.2.1&auto=format&fit=crop&w=2850&q=80')",
          ...
          <div className="container relative z-10 mx-auto px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-xl sm:text-xl/relaxed text-gray-300">
                Discover our curated collection of the world's finest luxury vehicles.
        ...
        <section className="bg-background py-24 sm:py-32">
          <div className="container">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Featured Vehicles</h2>
              <p className="mt-2 text-lg text-muted-foreground">
            ...
            <div className="mx-auto mt-16 grid max-w-7xl grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="group relative overflow-hidden rounded-lg">
                ...
                <div className="p-6 bg-card">
                  <h3 className="text-xl font-bold mb-2">Bentley Flying Spur</h3>
                  <p className="text-2xl font-bold text-primary mb-4">€320,000</p>
                  <Button asChild>
              ...
              <div className="group relative overflow-hidden rounded-lg">
                ...
                <div className="p-6 bg-card">
                  <h3 className="text-xl font-bold mb-2">Ferrari SF90 Stradale</h3>
                  <p className="text-2xl font-bold text-primary mb-4">€500,000</p>
                  <Button asChild>
              ...
              <div className="group relative overflow-hidden rounded-lg">
                ...
                <div className="p-6 bg-card">
                  <h3 className="text-xl font-bold mb-2">Rolls-Royce Phantom</h3>
                  <p className="text-2xl font-bold text-primary mb-4">€450,000</p>
                  <Button asChild>
