          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-12">
                En Luxury Motors, ofrecemos una gama de servicios diseñados para
                brindarte una experiencia automotriz de lujo incomparable.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="bg-card rounded-xl shadow-lg text-center p-6 group relative overflow-hidden border border-gray-200 dark:border-white/20 shadow-md dark:shadow-white/10 bg-card transition-all duration-300 hover:shadow-xl dark:hover:shadow-white/20">
                ...
                <p className="text-muted-foreground">
                  Nuestro equipo de expertos te ofrece un asesoramiento
                  exclusivo, adaptado a tus preferencias y necesidades.
                </p>
              ...
              <div className="bg-card rounded-xl shadow-lg text-center p-6 group relative overflow-hidden border border-gray-200 dark:border-white/20 shadow-md dark:shadow-white/10 bg-card transition-all duration-300 hover:shadow-xl dark:hover:shadow-white/20">
                ...
                <p className="text-muted-foreground">
                  Todos nuestros vehículos cuentan con garantías extendidas y
                  revisiones certificadas para tu tranquilidad.
                </p>
                <div className="w-full h-64 mt-10 overflow-hidden rounded-lg flex items-center justify-center">
                  <Image
                    width={800}
              ...
              <div className="bg-card rounded-xl shadow-lg text-center p-6 group relative overflow-hidden border border-gray-200 dark:border-white/20 shadow-md dark:shadow-white/10 bg-card transition-all duration-300 hover:shadow-xl dark:hover:shadow-white/20">
                ...
                <p className="text-muted-foreground">
                  Recibe tu vehículo directamente en la puerta de tu casa, con
              ...
              <div className="bg-card rounded-xl shadow-lg text-center p-6 group relative overflow-hidden border border-gray-200 dark:border-white/20 shadow-md dark:shadow-white/10 bg-card transition-all duration-300 hover:shadow-xl dark:hover:shadow-white/20">
                ...
                <p className="text-muted-foreground">
                  Ofrecemos planes de financiación flexibles que se adaptan a tu
              ...
              <div className="bg-card rounded-xl shadow-lg text-center p-6 group relative overflow-hidden border border-gray-200 dark:border-white/20 shadow-md dark:shadow-white/10 bg-card transition-all duration-300 hover:shadow-xl dark:hover:shadow-white/20">
                ...
                <p className="text-muted-foreground">
                  Cada vehículo ha pasado por una rigurosa inspección para
              ...
              <div className="bg-card rounded-xl shadow-lg text-center p-6 group relative overflow-hidden border border-gray-200 dark:border-white/20 shadow-md dark:shadow-white/10 bg-card transition-all duration-300 hover:shadow-xl dark:hover:shadow-white/20">
                ...
                <p className="text-muted-foreground">
                  Nuestro compromiso continúa después de la compra, ofreciéndote
